...
namespace OAuth2.Client.Impl
{
    ...
    public class OdnoklassnikiClient : OAuth2Client
    {
        ...
        public OdnoklassnikiClient(IRequestFactory factory, IOAuth2Configuration configuration)
        ...
        protected override void BeforeGetUserInfo(IRestRequest request)
        {
            ...
            request.AddParameter("application_key", ClientConfiguration.ClientPublic);
            ...
            signature = (signature + (AccessToken + ClientConfiguration.ClientSecret).GetMd5Hash()).GetMd5Hash();
